return {
    ...
    },
    {
        ...
        event = "InsertEnter",
        ft = { "lua", "python", "sh", "c", "cpp", "arduino", "html", "css", "javascript", "ino" },
        config = function()
            ...
            local on_attach, _ =
                function(current_client, bufnr)
                    ...
                    callback = function(ev)
                        ...
                        vim.keymap.set("n", "<leader>lf", vim.lsp.buf.add_workspace_folder,
                            { desc = "Add workspace folder" }, opts)
                        vim.keymap.set("n", "<leader>lF", vim.lsp.buf.remove_workspace_folder,
